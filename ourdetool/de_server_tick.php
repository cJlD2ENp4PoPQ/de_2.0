...
echo '</tr></table>';
//select felder f�r die ticks generieren
$z=0;
echo '<br><b>Zu welchen Minuten sollen die Wirtschaftsticks ausgef�hrt werden?<br><br></b>';
echo '<table><tr>';
for ($i=0;$i<5;$i++)
{
  echo '<td valign=top>';
...
$z=0;
echo '<br><b>Zu welchen Minuten sollen die Kampfticks ausgef�hrt werden?<br><br></b>';
echo '<table><tr>';
for ($i=0;$i<5;$i++)
{
  echo '<td valign=top>';
